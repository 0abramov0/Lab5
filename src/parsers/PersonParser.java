...
public class PersonParser implements Parser<Person>{
    ...
    public Person fromMap(Map<String, Object> person){
        ...
        try{
            ...
            eyeColor = (person.get("eyecolor") == null ? null : HairColor.valueOf(((String) person.get("eyecolor")).toUpperCase()));
            hairColor = (person.get("haircolor") == null ? null : EyeColor.valueOf(((String) person.get("haircolor")).toUpperCase()));
    ...
    public Person fromConsole(Console console, String [] args){
        ...
        HairColor[] eyeColors = HairColor.values();
        for(var v: eyeColors){
            console.println("\t" + v);
        }
        while (true){
            ...
            try{
                if(!line.isEmpty()) {
                    eyeColor = HairColor.valueOf(line.toUpperCase());
                }
                else{
                    eyeColor = null;
                }
        ...
        EyeColor[] hairColors = EyeColor.values();
        ...
        while (true){
            ...
            try{
                if(!line.isEmpty()) {
                    hairColor = EyeColor.valueOf(line.toUpperCase());
                }
                else{
                    hairColor = null;
                }
